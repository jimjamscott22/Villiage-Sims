...
> **Status:** built through **Milestone 9** (population and progression). Milestone 10 is in progress with versioned manual save/load; autosaves, weather, the event log, and final polish remain — see the [roadmap](#roadmap).
...
| M10 | Persistence (save/load), weather, event log, polish | 🚧 In progress |
